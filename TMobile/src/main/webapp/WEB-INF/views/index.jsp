  ...
  <body>
    ...
    <main role="main">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
			<img class="first-slide" src="<jstl:url value="/resources/images/world1_bg.jpg"/>" alt="First slide">
            <div class="container">
              <div class="carousel-caption text-left outline">
                <h1>T-Mobile</h1>
                <p>Delivering seamless connectivity powering global connectivity on land, at sea and in the air, T-Mobile is the world’s first high-speed, broadband Ka-band network, from a single operator.</p>
              </div>
            </div>
          </div>
      ...
      <footer class="container">
        ...
        <p>&copy; 2017-2018 TMobile, Inc. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
    </main>
    ...
    <script src="<jstl:url value="/resources/js/holder.min.js"/>">
  </body>
</html>
