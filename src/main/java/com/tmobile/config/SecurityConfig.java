...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.DELETE, "/tariffs").hasRole("MANAGER")
                .antMatchers(HttpMethod.POST, "/tariffs").hasRole("MANAGER")
                .antMatchers(HttpMethod.PUT, "/tariffs").hasRole("MANAGER")

                .antMatchers(HttpMethod.DELETE, "/options").hasRole("MANAGER")
                ...
                .antMatchers(HttpMethod.GET, "/options/required").hasAnyRole("CUSTOMER", "MANAGER")
